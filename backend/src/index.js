...
(async () => {
  try {
    ...
    await db.query(`
      ...
      CREATE TABLE IF NOT EXISTS csharp_modules (
        id SERIAL PRIMARY KEY,
        title VARCHAR(255) NOT NULL,
        subtitle VARCHAR(555),
        duration VARCHAR(100),
      ...
      CREATE TABLE IF NOT EXISTS csharp_topics (
        id SERIAL PRIMARY KEY,
        module_id INTEGER REFERENCES csharp_modules(id) ON DELETE CASCADE,
        title VARCHAR(255) NOT NULL,
        content TEXT,
        order_index INTEGER DEFAULT 0
      );

      CREATE TABLE IF NOT EXISTS csharp_quizzes (
        id SERIAL PRIMARY KEY,
        topic_id INTEGER REFERENCES csharp_topics(id) ON DELETE CASCADE,
        question TEXT NOT NULL,
        options JSONB NOT NULL,
      ...
      CREATE TABLE IF NOT EXISTS csharp_progress (
        id SERIAL PRIMARY KEY,
        student_id INTEGER UNIQUE REFERENCES users(id) ON DELETE CASCADE,
        completed_topics INTEGER DEFAULT 0,
        study_hours NUMERIC DEFAULT 0.0,
      ...
      CREATE TABLE IF NOT EXISTS csharp_practice (
        id SERIAL PRIMARY KEY,
        type VARCHAR(100) NOT NULL,
        question TEXT NOT NULL,
        options JSONB,
      ...
      CREATE TABLE IF NOT EXISTS csharp_projects (
        id SERIAL PRIMARY KEY,
        title VARCHAR(255) NOT NULL,
        description TEXT,
        difficulty VARCHAR(50) DEFAULT 'medium',
      ...
      CREATE TABLE IF NOT EXISTS csharp_submissions (
        id SERIAL PRIMARY KEY,
        student_id INTEGER REFERENCES users(id) ON DELETE CASCADE,
        project_id INTEGER REFERENCES csharp_projects(id) ON DELETE CASCADE,
        status VARCHAR(50) DEFAULT 'In Progress',
        code_quality VARCHAR(100) DEFAULT 'Not Reviewed',
        progress INTEGER DEFAULT 0,
        submitted_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
      ...
      CREATE TABLE IF NOT EXISTS csharp_analytics (
        id SERIAL PRIMARY KEY,
        student_id INTEGER REFERENCES users(id) ON DELETE CASCADE,
        date DATE NOT NULL,
        learning_time INTEGER DEFAULT 0,
      ...
      CREATE TABLE IF NOT EXISTS csharp_certificates (
        id SERIAL PRIMARY KEY,
        student_id INTEGER UNIQUE REFERENCES users(id) ON DELETE CASCADE,
        certificate_id VARCHAR(100) UNIQUE NOT NULL,
        issued_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
      ...
      CREATE TABLE IF NOT EXISTS csharp_achievements (
        id SERIAL PRIMARY KEY,
        student_id INTEGER REFERENCES users(id) ON DELETE CASCADE,
        title VARCHAR(255) NOT NULL,
        xp_reward INTEGER DEFAULT 100,
      ...
      CREATE TABLE IF NOT EXISTS csharp_ai_recommendations (
        id SERIAL PRIMARY KEY,
        student_id INTEGER UNIQUE REFERENCES users(id) ON DELETE CASCADE,
        recommendations TEXT,
        strength_areas TEXT,
